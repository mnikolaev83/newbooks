...
export class FavoriteListItem extends Component {
    ...
    removeFromFavoriteList() {
        this.props.removeFromFavoriteList(this.props.itemid);
    };
    render() {
        ...
        return (
            <div className={this.state.isRemoved ? "hidden" : "table-list-item favorite row"}>
                <div className={this.state.waitMode ? 'main-wait' : 'hide'}>
                </div>
                <div className="col-sm-1 trash">
                    <FontAwesomeIcon icon="trash-alt" onClick={this.removeFromFavoriteList.bind(this)}/>
                </div>
